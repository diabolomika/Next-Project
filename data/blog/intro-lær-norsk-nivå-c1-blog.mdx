---
title: 'Introducing Lær norsk Nivå C1 Blog'
date: '2021-01-12'
lastmod: '2024-06-02'
tags: ['next-js', 'tailwind', 'guide']
draft: false
summary: 'Looking for a performant, out of the box instruction, based on Linguistic methods to support your language journey in one cpmpresehnsive blogging needs? Checkout the Tailwind Nextjs Starter Blog template.'
