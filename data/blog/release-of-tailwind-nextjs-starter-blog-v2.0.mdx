...
Jeg begynte med dansk A1/A2 for mange år siden. Jeg var på universitetet og hadde akkurat vært på Island, Finland og Farøy og akkurat begynt. Siden jeg aldri kom på kurset på grunn av tidsnød, lærte jeg nesten alt fra boken og CD-en. Men jeg kunne egentlig ikke snakke så mye. Jeg prøvde også å lære meg finsk, men ga opp etter 3 uker og gikk over til fransk, noe jeg allerede til en viss grad kunne.
Jeg var totalt 1 måned i Norge under studiene fordi jeg lærte meg langrenn. Men jeg snakket bare engelsk der. Først senere, etter å ha bodd i USA i 15 år, besøkte jeg familie i Norge.
Jeg har forbedret norsken min ved å se mange serier (f.eks. Lilyhammer) på norsk. Hvis jeg ikke kan et ord, slår jeg det opp umiddelbart og skriver det ned i boken min. Dette gjør at jeg raskt kan lære meg nytt ordforråd, og fordi jeg hører norsk snakket på normalt språk hjelper det automatisk på grammatikken min.
